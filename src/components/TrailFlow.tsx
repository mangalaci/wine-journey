    ...
    >
      ...
      >
        <svg viewBox="0 0 100 155" className="w-40" aria-hidden>
          ...
          {/* Glass body */}
          <path
            d="M 15,5 C 2,45 2,88 42,104 L 46,138 C 44,139 24,141 18,144 C 14,147 18,149 50,149 C 82,149 86,147 82,144 C 76,141 56,139 54,138 L 58,104 C 98,88 98,45 85,5 Z"
          ...
          {/* Glass outline */}
          <path
            d="M 15,5 C 2,45 2,88 42,104 L 46,138 C 44,139 24,141 18,144 C 14,147 18,149 50,149 C 82,149 86,147 82,144 C 76,141 56,139 54,138 L 58,104 C 98,88 98,45 85,5"
            fill="none"
            stroke="#8c1c2c"
            strokeWidth="2.2"
